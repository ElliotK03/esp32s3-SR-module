...
dac_audio_item_t playlist[] = {
    ...
    {"wake_up_prompt_tone", (uint16_t *)wake_up_prompt_tone,
     sizeof(wake_up_prompt_tone)},
    {"me_tell_me_a_joke", (uint16_t *)me_tell_me_a_joke,
     sizeof(me_tell_me_a_joke)},
    {"me_sing_a_song", (uint16_t *)me_sing_a_song, sizeof(me_sing_a_song)},
    {"me_play_news_channel", (uint16_t *)me_play_news_channel,
     sizeof(me_play_news_channel)},
    {"me_turn_on_my_soundbox", (uint16_t *)me_turn_on_my_soundbox,
     sizeof(me_turn_on_my_soundbox)},
    {"me_turn_off_my_soundbox", (uint16_t *)me_turn_off_my_soundbox,
     sizeof(me_turn_off_my_soundbox)},
    {"me_highest_volume", (uint16_t *)me_highest_volume,
     sizeof(me_highest_volume)},
    {"me_lowest_volume", (uint16_t *)me_lowest_volume,
     sizeof(me_lowest_volume)},
    {"me_increase_volume", (uint16_t *)me_increase_volume,
     sizeof(me_increase_volume)},
    {"me_decrease_the_volume", (uint16_t *)me_decrease_the_volume,
     sizeof(me_decrease_the_volume)},
    {"me_turn_on_the_TV", (uint16_t *)me_turn_on_the_TV,
     sizeof(me_turn_on_the_TV)},
    {"me_turn_off_the_TV", (uint16_t *)me_turn_off_the_TV,
     sizeof(me_turn_off_the_TV)},
    {"me_make_me_a_tea", (uint16_t *)me_make_me_a_tea,
     sizeof(me_make_me_a_tea)},
    {"me_make_me_a_coffee", (uint16_t *)me_make_me_a_coffee,
     sizeof(me_make_me_a_coffee)},
    {"me_turn_on_the_light", (uint16_t *)me_turn_on_the_light,
     sizeof(me_turn_on_the_light)},
    {"me_turn_off_the_light", (uint16_t *)me_turn_off_the_light,
     sizeof(me_turn_off_the_light)},
    {"me_red_color", (uint16_t *)me_red_color, sizeof(me_red_color)},
    {"me_green_color", (uint16_t *)me_green_color, sizeof(me_green_color)},
    {"me_turn_on_all_the_light", (uint16_t *)me_turn_on_all_the_light,
     sizeof(me_turn_on_all_the_light)},
    {"me_turn_off_all_the_light", (uint16_t *)me_turn_off_all_the_light,
     sizeof(me_turn_off_all_the_light)},
    {"me_turn_on_the_air_conditioner",
     (uint16_t *)me_turn_on_the_air_conditioner,
     sizeof(me_turn_on_the_air_conditioner)},
    {"me_turn_off_the_air_conditioner",
     (uint16_t *)me_turn_off_the_air_conditioner,
     sizeof(me_turn_off_the_air_conditioner)},
...
//   esp_audio_play((int16_t *)(playlist[0].data), playlist[0].length,
//                  portMAX_DELAY);
// }

void speech_commands_action(int command_id) {
  esp_audio_play((int16_t *)(playlist[command_id + 1].data),
                 playlist[command_id + 1].length, portMAX_DELAY);
}
